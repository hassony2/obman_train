...
def hand_obj_children(obj_verts=None,
                      obj_faces=None,
                      gt_obj_verts=None,
                      gt_obj_faces=None,
                      hand_verts=None,
    ...
    if obj_verts is not None:
        geo_obj = p3js.Geometry(
            vertices=obj_verts.tolist(), faces=obj_faces.tolist())
        geo_obj.exec_three_obj_method('computeFaceNormals')
        mat = p3js.MeshLambertMaterial(
            color='red', side='FrontSide', transparent=True)
    ...
    if hand_verts is not None:
        ...
        mat = p3js.MeshLambertMaterial(
            color='blue', side='FrontSide', transparent=True)
