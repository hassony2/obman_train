def add_dataset_opts(parser):
    ...
    parser.add_argument(
        '--train_datasets',
        choices=[
            'fhbhands', 'fhbhands_obj', 'fhbhands_hand', 'dexterobj',
            'dimsynthands', 'panoptic', 'ganhands', 'tomasreal', 'tomasynth',
            'zimsynth', 'yanasynth', 'stereohands', 'lsm3d', 'zimsynth',
            'tzionas', 'synthcube'
    ...
    parser.add_argument(
        '--val_datasets',
        choices=[
            'dexterobj', 'tomasreal', 'tomasynth', 'yanasynth', 'stereohands',
